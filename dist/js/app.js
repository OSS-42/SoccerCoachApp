...
function exportReport(gameId, format) {
    ...
    if (format === 'pdf') {
        ...
        showMessage('Taking screenshot of report...', 'success');
        
        // Create an offscreen element to capture
        const element = document.createElement('div');
        element.innerHTML = `
            <div style="font-family: Arial, sans-serif; padding: 20px; background: white; width: 800px;">
                ${reportContent}
                <p style="margin-top: 30px; text-align: center; color: #666;">
                    Generated by Soccer Coach Tracker - ${new Date().toLocaleString()}
                </p>
        ...
        // Let user know they need to take a screenshot
        alert('Please take a screenshot of the report now. Click OK when done.');
        
        // Remove the element after they confirm
