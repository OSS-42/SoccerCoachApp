        ...
        reportDialog.innerHTML = `
            <div class="dialog-content report-dialog">
                ...
                <div class="report-actions">
                    <button class="secondary-btn" onclick="ReportService.exportReport('${gameId}', 'pdf')">${window.renderSplitButtonContent('PDF', 'picture_as_pdf')}</button>
                    <button class="primary-btn" onclick="ReportService.closeDetailedReport()">${window.renderSplitButtonContent('Close', 'close')}</button>
                </div>
            </div>
        `;
    ...
    generateEnhancedReport(gameId) {
        ...
        reportDialog.innerHTML = `
            <div class="dialog-content game-report-content">
                ...
                ${reportHTML}
                <div class="report-actions">
                    <button class="primary-btn" onclick="ReportService.printEnhancedReport('${gameId}')">${window.renderSplitButtonContent('PDF', 'picture_as_pdf')}</button>
                    <button class="secondary-btn" onclick="ReportService.shareReport('${gameId}')">${window.renderSplitButtonContent('Share', 'share')}</button>
                    <button class="secondary-btn" onclick="this.closest('.dialog').classList.remove('active')">${window.renderSplitButtonContent('Close', 'close')}</button>
                </div>
            </div>
        `;
